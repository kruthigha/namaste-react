...
const Header = ()=>{
    ...
    return(<div className="flex justify-between bg-gray-100 lg:bg-gray-300  sm:bg-gray-200 shadow-lg h-24">
        ...
        <li  className="px-4 justify-items-center ">Online Staus:{status?"✅":"🔴"}</li>
        ...
        <li className="px-4 justify-items-center"><Link to="/">Cart</Link></li>
        <button className="p-1  bg-orange-400 rounded-sm" id="lgn-btn" onClick={()=>{
            setLogin((t)=>{
               return !t;
            })
        }}>{login?loggedInUser:"Login"}</button>
